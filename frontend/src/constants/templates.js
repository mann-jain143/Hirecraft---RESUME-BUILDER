export const TEMPLATE_LIST = [
  { id: 'classic', name: 'Classic ATS', category: 'Corporate', hasPhoto: false, description: 'Clean centered header, ATS-friendly' },
  { id: 'ats-minimal', name: 'ATS Minimal', category: 'Corporate', hasPhoto: false, description: 'Ultra-minimal single column' },
  { id: 'corporate', name: 'Corporate Pro', category: 'Corporate', hasPhoto: false, description: 'Formal executive layout' },
  ...
  { id: 'minimal-serif', name: 'Elegant Serif', category: 'Corporate', hasPhoto: false, description: 'Refined serif typography' },
  { id: 'bold-blocks', name: 'Bold Blocks', category: 'Creative', hasPhoto: false, description: 'Color-block section headers' },
  { id: 'compact', name: 'Compact Pro', category: 'Corporate', hasPhoto: false, description: 'Dense information layout' },
  { id: 'modern-lines', name: 'Modern Lines', category: 'Modern', hasPhoto: false, description: 'Horizontal accent rules' },
  { id: 'executive', name: 'Executive', category: 'Corporate', hasPhoto: false, description: 'Top accent bar, premium feel' },
  { id: 'sidebar-photo', name: 'Sidebar Portrait', category: 'Modern', hasPhoto: true, description: 'Left sidebar with circular photo' },
  { id: 'banner-photo', name: 'Banner Profile', category: 'Creative', hasPhoto: true, description: 'Full-width banner with square photo' },
  ...
  { id: 'stack-photo', name: 'Stack Portrait', category: 'Modern', hasPhoto: true, description: 'Stacked photo above name' },
  { id: 'corner-photo', name: 'Corner Square', category: 'Corporate', hasPhoto: true, description: 'Square photo top-left corner' },
